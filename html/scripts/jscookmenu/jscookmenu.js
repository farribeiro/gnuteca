/*
	JSCookMenu v2.0.2 (c) Copyright 2002-2006 by Heng Yuan
*/
...
function cmActionItem (item, isMain, idSub, menuInfo, menuID)
{
    ...
    return returnStr + ' onmouseout="cmItemMouseOut (' + param + ')"';
}
...
function cmDrawSubMenu (subMenu, prefix, id, nodeProperties, zIndexStart, menuInfo, menuID)
{
	...
	for (i = 5; i < subMenu.length; ++i)
	{
        ...
        {
		    str += '</td><td class="' + classStr + 'Text"><a onclick="miolo.doLink(\'' + item[2]  +'\', \'frm__mainForm\'); return false" href="' + item[2]  + '">' + item[1] + '</a>';
        }
        else
        {
...
function cmItemMouseUp (obj, isMain, idSub, menuID, index)
{
	...
	if (link != null)
	{
        ...
        try
        {
            ...
            miolo.doLink(link, 'frm__mainForm');
        }
        catch(err)
        {
            txt  = "Erro: " + + err.description + "\n\n";
...
//var cmThemeOffice={mainFolderLeft:'&nbsp;',mainFolderRight:'&nbsp;',mainItemLeft:'&nbsp;',mainItemRight:'&nbsp;',folderLeft:'<img alt="" src="/images/spacer.gif">',folderRight:'<img alt="" src="/images/arrow.gif">',itemLeft:'<img alt="" src="/images/spacer.gif">',itemRight:'<img alt="" src="/images/blank.gif">',mainSpacing: 0,subSpacing: 0,delay: 500};var cmThemeOfficeHSplit=[_cmNoClick,'<td class="ThemeOfficeMenuItemLeft"></td><td colspan="2"><div class="ThemeOfficeMenuSplit"></div></td>'];var cmThemeOfficeMainHSplit=[_cmNoClick,'<td class="ThemeOfficeMainItemLeft"></td><td colspan="2"><div class="ThemeOfficeMenuSplit"></div></td>'];var cmThemeOfficeMainVSplit=[_cmNoClick,'|'];var cmThemeOffice2003=cmThemeOffice;var cmThemeOffice2003HSplit=[_cmNoClick,'<td class="ThemeOffice2003MenuItemLeft"></td><td colspan="2"><div class="ThemeOffice2003MenuSplit"></div></td>'];var cmThemeOffice2003MainHSplit=[_cmNoClick,'<td class="ThemeOffice2003MainItemLeft"></td><td colspan="2"><div class="ThemeOffice2003MenuSplit"></div></td>'];var cmThemeOffice2003MainVSplit=[_cmNoClick,'|'];
