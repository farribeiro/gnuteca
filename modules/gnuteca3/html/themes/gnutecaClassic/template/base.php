...
<html>
    <head>
        <title>Biblioteca Univates</title>
        <link rel="stylesheet" type="text/css" href="<?php echo $url ?>/themes/<?php echo $theme->id ?>/gnuteca.css">
        <link rel="stylesheet" type="text/css" href="<?php echo $url ?>/file.php?folder=searchTheme&file=search.css">
    ...
    <body class="mThemeBody" onLoad="carregaMenu();">
        <div id="<?php echo $id ?>">
            ...
            <div id="gUpperBar" class="mThemeContainerTop">
                ...
                <div id="gMainMenu" class="gMainMenu">
                    <?php
                        ...
                        $sysMenu = new GMainMenu('system'); $sysMenu->createMainMenu();
                        echo '<script>'.$sysMenu->generateInner().'</script>';
                    ?>
                </div>
