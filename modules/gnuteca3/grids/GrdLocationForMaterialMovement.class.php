 ...
 * MA 02110-1301, USA --->
 * 
 * Location for material movement grid
 *
 ...
 **/
class GrdLocationForMaterialMovement extends GSearchGrid
{
    public $MIOLO;
    public $module;
    public $action;
    ...
    public function __construct($data)
    {
        ...
        $columns = array(
            ...
            new MGridColumn(_M('Enviar recibo de empréstimo por e-mail', $this->module),   MGrid::ALIGN_CENTER, null, null, true,  $yn, true),
            new MGridColumn(_M('Enviar recibo de renovação por e-mail', $this->module),  MGrid::ALIGN_CENTER, null, null, true,  $yn, true),
            new MGridColumn(_M('Enviar recibo de devolução por e-mail', $this->module), MGrid::ALIGN_CENTER, null, null, true,  $yn, true)
        );
        ...
        $args = array(
            'function'                      => 'update',
            'locationForMaterialMovementId' => '%0%'
        );
