...
class GrdNews extends GSearchGrid
{
    ...
    public function __construct($data)
    {
        ...
        $columns = array(
            ...
            new MGridColumn( _M('Data', $this->module),                  MGrid::ALIGN_LEFT,  null, null, true, null, true ),
            new MGridColumn( _M('Data inicial', $this->module),          MGrid::ALIGN_LEFT,  null, null, true, null, true ),
            new MGridColumn( _M('Data final', $this->module),            MGrid::ALIGN_LEFT,  null, null, true, null, true ),
