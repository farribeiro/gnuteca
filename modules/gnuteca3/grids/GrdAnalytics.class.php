...
class GrdAnalytics extends GSearchGrid
{
    ...
    public function __construct($data)
    {
        ...
        $columns = array(
            ...
            new MGridColumn(_M('Ação',  $this->module), MGrid::ALIGN_CENTER,null, null, true, null, true),
            ...
            new MGridColumn(_M('Hora',  $this->module), MGrid::ALIGN_LEFT,  null, null, true, null, true),
            ...
            new MGridColumn(_M('Tempo gasto',$this->module), MGrid::ALIGN_LEFT,  null, null, true, null, true),
        );
