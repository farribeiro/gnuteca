...
class GrdReservesHistory extends GGrid
{
    ...
    public function __construct($data)
    {
        ...
        $columns = array(
            ...
            new MGridColumn( _M('Data da solicitação', $this->module),       MGrid::ALIGN_LEFT,   null, null, true,  null, true ),
            new MGridColumn( _M('Data limite', $this->module),           MGrid::ALIGN_LEFT,   null, null, true,  null, true ),
