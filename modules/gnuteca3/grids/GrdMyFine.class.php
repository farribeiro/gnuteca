...
class GrdMyFine extends GGrid
{
    ...
    public function __construct($data)
    {
        ...
        $columns = array(
            ...
            new MGridColumn(_M('Data da multa', $this->module),          MGrid::ALIGN_CENTER,   null, null, true, null, true),
            ...
            new MGridColumn(_M('Data final', $this->module),           MGrid::ALIGN_RIGHT,    null, null, false, null, true),
