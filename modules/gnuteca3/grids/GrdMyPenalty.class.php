...
class GrdMyPenalty extends GGrid
{
    ...
    public function __construct($data)
    {
        ...
        $columns = array(
            ...
            new MGridColumn(_M('Data da penalidade', $this->module),      MGrid::ALIGN_CENTER,  null, null, true,  null, true),
            new MGridColumn(_M('Data final de penalidade', $this->module),  MGrid::ALIGN_CENTER,  null, null, true,  null, true),
