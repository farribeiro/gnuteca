...
class GrdRequestChangeExemplaryStatus extends GSearchGrid
{
    ...
    function __construct($data)
    {
        ...
        (
            ...
            new MGridColumn( _M('Data',                     $this->module), MGrid::ALIGN_CENTER,   null, null, true,  null, true ),
            new MGridColumn( _M('Data final',               $this->module), MGrid::ALIGN_CENTER,   null, null, true,  null, true ),
