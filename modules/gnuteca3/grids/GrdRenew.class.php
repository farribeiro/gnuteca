...
class GrdRenew extends GSearchGrid
{
    ...
    public function __construct($data)
    {
        ...
        $columns = array(
         ...
         //   new MGridColumn(_M('Data de renovação', $this->module),          MGrid::ALIGN_RIGHT,  null, null, true, null, true),
          //  new MGridColumn(_M('Data prevista da devolução', $this->module), MGrid::ALIGN_RIGHT,  null, null, true, null, true),
            new MGridColumn(_M('Data prevista da devolução', $this->module), MGrid::ALIGN_RIGHT,  null, null, true, null, true),
            new MGridColumn(_M('Data de renovação', $this->module),          MGrid::ALIGN_RIGHT,  null, null, true, null, true),
    ...
    public function checkValues($i, $row, $actions, $columns)
    {
        ...
        $columns[8]->control[$i]->setValue($returnForecastDate->getDate(GDate::MASK_DATE_USER));
        ...
        $newRenewDate = new GDate($renew[0]->newreturnforecastdate); 
        $columns[10]->control[$i]->setValue($newRenewDate->getDate(GDate::MASK_DATE_USER));
