 ...
 **/
class GrdOperationLoan extends GGrid
{
    public $MIOLO;
    public $module;
    public $action;
    ...
    public function __construct($data)
    {
        ...
        $columns = array(
            ...
            new MGridColumn(_M('Mensagem de devolução',    $this->module), MGrid::ALIGN_LEFT,   null, null, true, null, true),
        ...
        parent::__construct($data, $columns, $this->MIOLO->getCurrentURL(), 0, 0, 'gridOperationLoan');
