...
class GrdMyLoan extends GGrid
{
    ...
    public function __construct($data)
    {
        ...
        $columns = array(
            ...
            new MGridColumn(_M('Data do empréstimo', $this->module),             MGrid::ALIGN_CENTER, null, null, true, null, true),
            new MGridColumn(_M('Data prevista da devolução', $this->module),  MGrid::ALIGN_CENTER, null, null, true, null, true),
            new MGridColumn(_M('Data de devolução', $this->module),           MGrid::ALIGN_CENTER, null, null, true, null, true),
