...
class GrdInterchange extends GSearchGrid
{
    ...
    public function __construct($data)
    {
        ...
        $columns = array(
            ...
            new MGridColumn(_M('Data', $module),         MGrid::ALIGN_RIGHT,  null, null, true,  null, true),
        ...
        {
            $args['event'] = 'loadFields';
            $args['supplierId'] = '%2%';
            $args['function'] = 'update';

	        $this->addActionIcon(_M('Editar fornecedor', $this->module), GUtil::getImageTheme('user-16x16.png'), $MIOLO->getActionURL($module, 'main:administration:supplier', null, $args));
    ...
    public function checkValues($i, $row, $actions, $columns)
    {
        ...
        $x = 0;
        if ($this->actionUpdate) $x++;
        if ($this->actionDelete) $x++;
