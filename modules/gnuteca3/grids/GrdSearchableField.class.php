 ...
 *
 **/
class GrdSearchableField extends GSearchGrid
{
    public function __construct($data)
    {
        ...
        $columns = array(
            ...
            new MGridColumn(_M('Identificador', $module),    MGrid::ALIGN_LEFT,   null, null, true, null, true),
            new MGridColumn(_M('Observação', $module),   MGrid::ALIGN_LEFT,   null, null, true, null, true),
            new MGridColumn(_M('É restrita', $module), MGrid::ALIGN_CENTER, null, null, true, GUtil::listYesNo(), true),
            new MGridColumn(_M('Nível', $module),         MGrid::ALIGN_RIGHT,   null, null, true, null, true)
        );


        parent::__construct($data, $columns);

        $args['searchableFieldId'] = '%0%';
