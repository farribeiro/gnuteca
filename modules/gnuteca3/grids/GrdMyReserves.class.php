...
class GrdMyReserves extends GGrid
{
    function __construct($data)
    {
        ...
        (
            ...
            new MGridColumn( _M('Data da requisição', $this->module), MGrid::ALIGN_CENTER,   null, null, true, null, true ),
            new MGridColumn( _M('Data limite', $this->module), MGrid::ALIGN_CENTER,   null, null, true, null, true ),
