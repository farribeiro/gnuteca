...
class BusinessGnuteca3BusExemplaryControl extends GBusiness
{
     ...
     *
     **/
    public function updateExemplaryControl()
    {
        $this->clear();
        $this->setTables($this->table);
        ...
        $sql = $this->update( $this->associateData($columns . ',' . $this->pkeys) );
    ...
    private function updateMaterial($itemNumber, $content, $fieldId, $subfieldId, $exemplaryControl = null )
    {
        ...
        if ($exemplaryControl)
        {
            ...
            if ( $exemplaryTag ) //se existe o registro exclui ou altera
            {
                ...
                {
                    return $this->busMaterial->deleteMaterial();
                }
                else
                {
                    return $this->busMaterial->updateMaterialContent();
                }
            }
            else if ( $content )
            {
                return $this->busMaterial->insertMaterial();
            }
        }
