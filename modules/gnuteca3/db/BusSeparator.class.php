...
class BusinessGnuteca3BusSeparator extends GBusiness
{
   // public $colsNoId;
    ...
    public function insertSeparator()
    {
        ...
        $sql = "INSERT INTO gtcSeparator ( cataloguingFormatId,fieldId,subFieldId,content,fieldId2,subFieldId2 ) VALUES ( '{$this->cataloguingFormatId}','{$this->fieldId}','{$this->subFieldId}','{$content}','{$this->fieldId2}','{$this->subFieldId2}' )";
        $rs  = $this->execute($sql);
    ...
    public function updateSeparator()
    {
        ...
        $sql  = "UPDATE gtcSeparator SET cataloguingFormatId= '{$this->cataloguingFormatId}',fieldId= '{$this->fieldId}',subFieldId= '{$this->subFieldId}',content= '{$content}',fieldId2= '{$this->fieldId2}',subFieldId2= '{$this->subFieldId2}' WHERE separatorId = '{$this->separatorId}'";
        $rs  = $this->execute($sql);
