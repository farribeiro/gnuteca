...
class BusinessGnuteca3BusFile extends GBusiness
{
     ...
     *
     */
    public static function getAbsoluteFilePath($folder, $file, $ext=null)
    {
     ...
     * @param String $label
     */
    public static function openDownload( $folder , $baseFilename, $buffer = null , $label = null)
    {
        ...
        $MIOLO->page->onload("window.open('file.php?folder={$folder}&file={$baseFilename}{$label}')"); //abre popup de download no browser
    ...
    public function insertFile()
    {
        ...
        if ( ! in_array(true, $ok) )
        {
            ...
            throw new Exception( _M('Impossível enviar a imagem "@1" para a pasta "@2".', 'gnuteca3', $errorFile, $this->folder) );
        }
    ...
    public function backup()
    {
        ...
        $deny = array('tmp', 'receipt', 'grid', 'report', 'pdf', 'storage');
