...
class FrmDictionaryContent extends GForm
{
    ...
    public function tbBtnSave_click($sender = NULL)
    {
        ...
        {
            $args['olderContent']           = $olderContent;
            $args['currentContent']         = $currentContent;
     ...
     {
        $this->business-> updateMaterialContent( MIOLO::_REQUEST('dictionaryId') , MIOLO::_REQUEST('olderContent') , MIOLO::_REQUEST('currentContent'));
        parent::tbBtnSave_click($sender, $data);
     }
