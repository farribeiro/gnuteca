...
class FrmClassificationArea extends GForm
{
    ...
    public function mainFields()
    {
        ...
        $lblHelp            = new MLabel(_M('Utilizar vírgula para separar os valores.', $this->module) );
        ...
        $lblHelpIgnore      = new MLabel(_M('Utilizar vírgula para separar os valores.', $this->module) );
