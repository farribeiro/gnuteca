...
class FrmLocationForMaterialMovementSearch extends GForm
{
    ...
    public function mainFields()
    {
        ...
        $fields[] = new GSelection('sendLoanReceiptByEmailS', null, _M('Enviar recibo de empréstimo por e-mail', $this->module), GUtil::listYesNo(0));
        $fields[] = new GSelection('sendRenewReceiptByEmailS', null, _M('Enviar recibo de renovação por e-mail', $this->module), GUtil::listYesNo(0));
        $fields[] = new GSelection('sendReturnReceiptByEmailS', null, _M('Enviar recibo de devolução por e-mail', $this->module), GUtil::listYesNo(0));
