...
class FrmAnalyticsSearch extends GForm
{
    ...
    public function mainFields()
    {
        ...
        $lblBeginDate = new MLabel(_M('Data/Hora Início'),$this->module);
        $beginDateS = new MCalendarField('beginDateS');
        $beginHourS = new MTextField('beginHourS');
        $lblEndDate = new MLabel(_M('Data/Hora Fim'),$this->module);
        $endDateS = new MCalendarField('endDateS');
        $endHourS = new MTextField('endHourS');
        ...
        $fields[] = new MTextField('eventS', null, _M('Evento',$this->module),FIELD_DESCRIPTION_SIZE );
        ...
        $fields[] = new GContainer('beginDateContainer',array($lblBeginDate,$beginDateS,$beginHourS));
        $fields[] = new GContainer('endDateContainer',array($lblEndDate,$endDateS,$endHourS));
