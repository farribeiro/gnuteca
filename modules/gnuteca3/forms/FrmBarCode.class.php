...
class FrmBarCode extends GForm
{
    ...
    function __construct()
    {
        ...
        parent::__construct( _M('Código de barras', $this->module) );
    ...
    public function mainFields()
    {
        ...
        $fields[] = new MTextField('text', null, _M('Texto', $this->module), FIELD_DESCRIPTION_SIZE, _M( 'Pode-se utilizar campos marc e funções. Ex.: $245.a.','gnuteca3') );
        $fields[] = new GRadioButtonGroup('size', _M('Tamanho do código de barra','gnuteca3'), $this->getBarcodeList() );
        $fields[] = new GRadioButtonGroup('type', _M('Tipo','gnuteca3'), $this->getBarcodeTypeList() );
    ...
    {
        $flds[] = new MTextField('itemNumber', null, _M('Número do exemplar', $this->module), FIELD_ID_SIZE);
        $cols[] = new MGridColumn(_M('Número do exemplar', $this->module), MGrid::ALIGN_LEFT, true, null, true, 'itemNumber');
        $valids[] = new GnutecaUniqueValidator('itemNumber', _M('Número do exemplar', $this->module), 'required');
    ...
    public function tbBtnPrint_click($sender=NULL)
    {
        ...
        $this->MIOLO->getClass($this->module, 'report/rptBarCode');
