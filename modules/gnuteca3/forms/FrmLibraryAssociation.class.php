...
class FrmLibraryAssociation extends GForm
{
    ...
    public function mainFields()
    {
        ...
        $tableFields[] = $selection = new GSelection('libraryUnitId', null, _M('Unidade de biblioteca', $this->module), $this->businessLibraryUnit->listLibraryUnit());
        ...
        $tableFields[] = new MHiddenField('libraryUnitDescription', null, '', 10);
        ...
        $columns = array
        (
            new MGridColumn( _M('Código',         $this->module), 'right',    true, "10%", true, 'libraryUnitId'              ),
