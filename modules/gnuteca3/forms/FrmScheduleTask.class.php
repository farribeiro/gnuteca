...
class FrmScheduleTask extends GForm
{
    function __construct()
    {
        ...
        $this->setAllFunctions('ScheduleTask', array('scheduleTaskId', 'taskId', 'scheduleCycleId', 'parameters'), array('scheduleTaskId', 'scheduleCycleId', 'taskId', 'parameters'), array('scheduleTaskId', 'taskId', 'scheduleCycleId', 'parameters'));
        parent::__construct();
    }
    ...
    public function mainFields()
    {
    	...
    	$fields[] = new GContainer('cont3', array($parametesrLabel, new MTextField('parameters', '', '', FIELD_DESCRIPTION_SIZE), $hintParameters));
