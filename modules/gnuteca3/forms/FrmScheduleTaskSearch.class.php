...
class FrmScheduleTaskSearch extends GForm
{
    ...
    {
    	$this->setAllFunctions('ScheduleTask', array('scheduleTaskId', 'taskId', 'scheduleCycleId', 'parameters'), array('scheduleTaskId', 'taskId', 'scheduleCycleId', 'parameters'), array('scheduleTaskId', 'taskId', 'scheduleCycleId', 'parameters'));
        parent::__construct();
    }
    ...
    public function executeScript()
    {
        ...
        {
            $this->error(_M('A tarefa não foi executa!', $this->module), null, null, null, true);
        }
    }
