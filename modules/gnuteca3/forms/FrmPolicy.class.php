...
class FrmPolicy extends GForm
{
    ...
    public function mainFields()
    {
        ...
        $fields[] = $fineValue = new MTextField('fineValue', null, _M('Valor da multa',$this->module), FIELD_ID_SIZE);
        ...
        {
            $fineValue->setHint( _M('Caso o empréstimo seja momentâneo o valor é aplicado por hora.',$this->module));
        }
