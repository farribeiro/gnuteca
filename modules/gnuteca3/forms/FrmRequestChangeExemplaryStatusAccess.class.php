...
class FrmRequestChangeExemplaryStatusAccess extends GForm
{
    ...
    public function mainFields()
    {
        ...
        $tableFields[] = $selection = new GSelection('exemplaryStatusId', null, _M('Estado do exemplar', $this->module), $this->busExemplaryStatus->listExemplaryStatus());
        ...
        $tableFields[] = new MHiddenField('description');
