...
class FrmMaterialCirculationUserHistory extends FrmMaterialCirculationReserve
{
	...
	public function getFieldsReserve($args = null)
	{
		...
		$lblDate->setWidth(FIELD_LABEL_SIZE);
		$beginRequestedDateS_DATE     = new MCalendarField('beginRequestedDateS_DATE', $this->beginBeginDateS->value, null, FIELD_DATE_SIZE);
		$endRequestedDateS_DATE       = new MCalendarField('endRequestedDateS_DATE', $this->endRequestedDateS_DATE->value, null, FIELD_DATE_SIZE);
		$fields[] = new GContainer('hctDates', array($lblDate, $beginRequestedDateS_DATE, $endRequestedDateS_DATE));
		$validators[] = new MDateDMYValidator('beginRequestedDateS_DATE');
