...
class FrmSeparator extends GForm
{
    ...
    public function mainFields()
    {
        ...
        $fields[]   = new MTextField('fieldId', $this->fieldId->value, _M('Campo', $this->module), FIELD_DESCRIPTION_SIZE);
        $fields[]   = new MTextField('subFieldId', $this->subFieldId->value, _M('Subcampo', $this->module), FIELD_DESCRIPTION_SIZE);
        $fields[]   = new MTextField('content', $this->content->value, _M('Conteúdo', $this->module), FIELD_DESCRIPTION_SIZE);
        $fields[]   = new MTextField('fieldId2', $this->fieldId2->value, _M('Campo 2', $this->module), FIELD_DESCRIPTION_SIZE);
        $fields[]   = new MTextField('subFieldId2', $this->subFieldId2->value, _M('Subcampo 2', $this->module), FIELD_DESCRIPTION_SIZE);
