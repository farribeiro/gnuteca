...
class GStatusBar extends MDiv
{
    ...
    public static function statusAbout()
    {
        ...
        $devel[] = array('',                           'Eduardo Bonfandini');
        $devel[] = array('<b>Analista Univates</b>',   'Willian Walmorbida');
        $devel[] = array('<b>Desenvolvedor</b>',       'Eduardo Bonfandini');
        $devel[] = array('',                           'Jader Osvino Finguenbaun ');
        $devel[] = array('',                           'Guilherme Soares Soldateli');
        $devel[] = array('<b>Testes</b>',              'Willian Walmorbida');
        $devel[] = array('<b>Documentador</b>',        'Eduardo Bonfandini');
        $devel[] = array('<b>Documentador</b>',        'Guilher Soares Soldateli');
        $devel[] = array('<b>Designer</b>',            'Eduardo Bonfandini');
        $devel[] = array('<b>Bibliotecária</b>',       'Ana Paula Monteiro');
        $devel[] = array('',                           'Carla Barzotto');
        $devel[] = array('',                           'Maristela Hilgemann Mendel');
        $devel[] = array('<b>Instrutor</b>',           'Paulo Koetz');
        $devel[] = array('<b>Novas tecnologias</b>',   'Armando Taffarel Neto');
        $devel[] = array('',                           'Daniel Hartmann');
        $devel[] = array('<b>Gestor de conta</b>',     'Fernando Kochhann');
        $devel[] = array('',                           'Leovan Tavares da Silva');
        ...
        $fields[]   = new MDiv('opensource', 'Contato: <a href="mailto:negocios@solis.coop.br">negocios@solis.coop.br<a> (+55 51 3714-6653)');
