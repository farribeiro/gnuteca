...
class GPrinterClient
{
    ...
    function __construct($serverAddress = null, $serverPort = null)
    {
        ...
        if(is_null($serverAddress))
        {
            ...
            {
                //Se tiver o cabeçalho do NGinx
                if ( isset($_SERVER['HTTP_X_REAL_IP']) )
                {
                    //Define cabeçalho do NGINX
                    $this->serverAddress = $_SERVER['HTTP_X_REAL_IP'];
                }
                else
                {
                    //Define cabeçalho do Apache
                    $this->serverAddress = $_SERVER['REMOTE_ADDR'];    
                }
            }
        }
        else
