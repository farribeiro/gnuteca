...
class GForm extends MForm
{
     ...
     */
    public function verifyModified($args)
    {
	...
	public static function getCloseButton( $extraJavaScript )
	{
        $MIOLO  = MIOLO::getInstance();
        $module = MIOLO::getCurrentModule();
    ...
    */ 
	 ...
	 */
	public function jsShow( $fieldId, $label )
	{
	 ...
	 */
	public function jsHide($fieldId, $label)
	{
        $label = $label ? 'true' : 'false';
	...
	{
		$formId = $this->page->getFormId();
		$this->page->onload('document.forms[0].reset();');
    ...
    public function getData($filterRepetitiveFields = false)
    {
        ...
        $repetitives = array_keys($session->getValue('GRepetitiveField'));
