...
class GUtil
{
     ...
     * @return string
     */
    public static function getActionLink($action,$formName, $class='miolo')
    {
     ...
     * @param string $label
     */
    public static function accessibility( $field, $tabIndex, $label )
    {
    ...
    public static function getPersonPhoto( $personId , $attributes )
    {
        ...
        return new MImage('personPhoto'.$personId, _M('Foto da pessoa @1','gnuteca3',$personId), $url);
    }
