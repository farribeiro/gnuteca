...
class TestWebservicematerial extends GUnitTest 
{
    ...
    public function teste1()
    {
        ...
        try
        {
            ...
            $result = $client->getExemplarFromWork( '1', base64_encode('123456'), array( 1000,1001,1002 ,'dd') ); //Retornar algum valor para comparar
            //$result = $client->getMaterialInformation('1', base64_encode('123456'), '1000', 1, 'XML' );
        }
        catch ( Exception $e)
        {
