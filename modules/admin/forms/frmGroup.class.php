...
class frmGroup extends AdminForm
{
    ...
    public function createFields()
    {
        ...
        $mtUsers = new MMultiTextField3( 'mtUsers', $idUsers, _M( 'Users', $module ), array( 
                $lkpUser, 
                $userName 
        ), 200, true, 'horizontal' );
        $fields[] = $mtUsers;
        ...
        $fields[] = new MBaseGroup( 'baseGroupAccess', _M( 'Permission', $module ), array( 
                $table 
        ) );
        /*Permissions*/
    ...
    public function save_click()
    {
        ...
        {
            $user = explode( ' ', ereg_replace( '\[|]', '', $mtUser ) ); //removes character [ and ] and explode in array
            $users[] = $user[0];
        }
