...
class MHtmlPainter extends MBasePainter
{
    ...
    public function inputCheck( $control )
    {
        ...
        return "\n<input " . $this->getAttribute('type',$control->type) . $this->getId() . $this->getName() . $this->getValue() . (($control->checked != '') ? " checked " : "") . $control->getAttributes() . ">". ($control->text != '' ? "<label " . $this->getAttribute('for',$control->id)  . $this->getClass() . ">" . $control->text . "</label>" : '');
    }
    ...
    public function image( $control )
    {
        ...
        return "\n<img" . $this->getAttribute('src',$control->location) . $this->getId() . $this->getClass() . $this->getAttribute('alt', $control->getAttribute('alt') ) . $this->getAttribute('title', $control->getAttribute('alt') ). $control->getAttributes() .">";
    }
    ...
    public function table( $control )
    {
        $this->control = $control;
        $body = $control->body;
        $html  = "\n<table " .  $this->getId() . $control->getAttributes() . $control->getClass() . ">";
    ...
    {
        $html = "\n<form id=\"$control->name\" name=\"$control->name\" method=\"post\" action=\"$control->action\" " . ($control->enctype != '' ? " enctype=\"$control->enctype\"" : '') . " >";
