 ...
 */
class MioloStatus extends ThemeElement
{
/**
 * Brief Description.
 ...
 */
    ...
    {   global $MIOLO, $HTTP_USER_AGENT;
        ...
        if ( $MIOLO->dump['profile'] )
        {
            ...
            $html .= "<$layerTag name=\"stats1\" style=\"$style\">" .
        ...
        if ( $MIOLO->dump['uses'] )
        {
            ...
            $html .= "<$layerTag name=\"stats2\" style=\"$style\">" .
                     "<div class=\"statisticsText\">\n" .
        ...
        if ( $MIOLO->dump['trace'] )
        {
            ...
            $html .= "<$layerTag name=\"stats3\" style=\"$style\">" .
                     "<div class=\"statisticsText\">\n" .
        ...
        if ( $html )
        {
            ...
            echo "<p><img src=\"/images/information.gif\" border=\"0\"" .
                 "width=\"24\" align=\"absolutemiddle\">&nbsp;" . $control ."</p>\n";
