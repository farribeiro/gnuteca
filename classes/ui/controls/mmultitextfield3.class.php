...
class MMultiTextField3 extends MMultiTextField2
{
    ...
    public function generateInner()
    {
        ...
        $field->addAttribute('onChange', "{$mtfName}.onSelect('{$ref}')");
        ...
        $button[] = new MButton("{$mtfName}_add", 'Adicionar',
                                "{$mtfName}.add('{$ref}')");
        $button[] = new MButton("{$mtfName}_modify", 'Modificar',
                                "{$mtfName}.modify('{$ref}')");
        $button[] = new MButton("{$mtfName}_remove", 'Remover',
                                "{$mtfName}.remove('{$ref}')");

        if ($this->shownav)
        {
            $button[] = new MButton("{$mtfName}_up", '/\\',
                                    "{$mtfName}.moveUp('{$ref}')");
            $button[] = new MButton("{$mtfName}_down", '\\/',
                                    "{$mtfName}.moveDown('{$ref}')");
        }
        ...
        elseif ($this->layout == 'horizontal')
        {
            ...
            $fieldPosH->addStyle('width', "{$this->fieldWidth}px");
            $t[] = $fieldPosH;
