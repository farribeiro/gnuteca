...
class MMultiTextField2 extends MTextField
{
    ...
    public function generateInner()
    {
        ...
        $mtfName = "mtf_{$formId}_{$this->name}";
        $this->page->addJsCode("{$mtfName} = new Miolo.MultiTextField2('{$this->name}');"); 

        $this->page->onSubmit("{$mtfName}.onSubmit('{$formId}','{$this->name}')");
        ...
        $field->addAttribute( 'onKeyDown', "return {$mtfName}.onKeyDown(this,this.form,'{$this->name}',event,$numFields);" );
        $field->addAttribute( 'onChange', "{$mtfName}.onSelect(this.form,'{$this->name}', $numFields)" );
        ...
        $button[] = new MButton( "{$mtfName}_add", 'Adicionar', "{$mtfName}.add($numFields)" );
        $button[] = new MButton( "{$mtfName}_modify", 'Modificar', "{$mtfName}.modify($numFields)" );
        $button[] = new MButton( "{$mtfName}_remove", 'Remover', "{$mtfName}.remove($numFields)" );
        ...
        $div = new MDiv( "m_{$mtfName}", $group, 'm-multitext-field' );
