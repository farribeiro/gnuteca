...
//        $this->addStyleFile('m_dhtmlmenu2_'.$this->themeStyle.'.css');
    ...
    public function generateInner()
    {
        ...
        $html = "<td id=\"m-container-menu{$this->nOrder}\">";
        $html .= "</td>";
        $this->inner = $html;
        ...
        $code .= "cmDraw( 'm-container-menu{$this->nOrder}', MAIN_MENU_JS_{$this->nOrder}, 'hbr', cm$themeName, '$themeName');";
