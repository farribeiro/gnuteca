...
//        $this->grid->setId($this->formName);
        ...
        //seta o focus do primeiro campo após o deliver do lookup
        ...
        $js         = "if ( elemento = dojo.byId('$focus') ) { setTimeout('dojo.byId(\'$focus\').focus()',500 ); }";

        $this->grid->setActionDefault("{$this->formName}.deliver('$this->formName', {$indexColumn}, '$args'); $js");
        $this->grid->setButtonSelectClass('grid_select');
    }
