...
class MDatabase
{
    ...
    public $conn;       // MConnection object
    ...
    public function __construct($conf, $system, $host, $db, $user, $pass, $persistent, $parameters = NULL, $server = false, $jdbc_driver, $jdbc_db)
   ...
   public function open()
   {
    ...
    public function query($sql, $maxrows = 0) // backward compatibility
    {
    ...
    public function getQuery($sql, $maxrows = 0)
    {
        if (isset($sql->range))
        {
    ...
    public function queryChunk($sql, $maxrows, $offset, &$total)
    {
